...
void Commands::DoSignedTranactionResponse(wxTreeCtrl* response_tree, signed_transaction result)
{
   ...
   response_tree->Collapse(ref_block_num);
   ...
   response_tree->Collapse(ref_block_prefix);
   ...
   response_tree->Collapse(expiration);
   ...
   response_tree->Expand(operations);
   ...
   response_tree->Collapse(signatures);
