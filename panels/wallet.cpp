...
#include "../plugins/assets/include/includes.hpp"
#include "../plugins/accounts/include/includes.hpp"
...
Wallet::Wallet(GWallet* gwallet) : wxPanel()
{
   ...
   tree.transfer_to_blind = wallet_tree->AppendItem(blinded, _("Transfer"));
...
void Wallet::OnCommand(wxTreeEvent& event)
{
   ...
   else if(selected == tree.transfer_to_blind)
